...
COPY dockerImages/required_jars/hadoop-aws-3.2.0.jar /usr/bin/spark-${spark_version}-bin-hadoop${hadoop_version}/jars/hadoop-aws-3.2.0.jar
COPY dockerImages/required_jars/hadoop-common-3.2.0.jar /usr/bin/spark-${spark_version}-bin-hadoop${hadoop_version}/jars/hadoop-common-3.2.0.jar
COPY dockerImages/required_jars/aws-java-sdk-1.11.30.jar /usr/bin/spark-${spark_version}-bin-hadoop${hadoop_version}/jars/aws-java-sdk-1.11.30.jar
